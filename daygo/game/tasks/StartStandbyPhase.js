...
const pikachu = new EntCard('Pikachu', 'light', 70, 40, 60)
alphaSide.addToSide('slotOne', pikachu)
const charizard = new EntCard('Charizard', 'dark', 90, 50, 95)
alphaSide.addToSide('slotTwo', charizard)
const dragonite = new EntCard('Dragonite', 'dark', 70, 50, 105)
alphaSide.addToSide('slotThree', dragonite)
const starmie = new EntCard('Starmie', 'lightning', 80, 300, 120)
alphaSide.addToSide('slotFour', starmie)


const snorlax = new EntCard('Snorlax', 'terra', 80, 300, 30)
omegaSide.addToSide('slotOne', snorlax)
const suicune = new EntCard('Suicune', 'water', 80, 300, 30)
omegaSide.addToSide('slotTwo', suicune)
const jirachi = new EntCard('Jirachi', 'basic', 100, 450, 100)
omegaSide.addToSide('slotThree', jirachi)
const castform = new EntCard('Castform', 'basic', 100, 450, 100)
